...
create table users(id integer primary key autoincrement, username varchar not null,password varchar not null, access varchar not null);
insert into users(username, password, access) values ('hilmi', 123, 'admin');
insert into users(username, password, access) values ('guest', 321, 'guest');
